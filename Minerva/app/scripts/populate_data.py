...
from app.models import UserProfile, Roles, DiarioDigital, Categoria, LinkRelevante, Articulo

# Crear usuarios
usuarios_data = [
    {'username': 'admin', 'email': 'admin@example.com', 'rol': Roles.ADMIN},
    {'username': 'prensa1', 'email': 'prensa1@example.com', 'rol': Roles.PRENSA},
    {'username': 'clasificador1', 'email': 'clasif1@example.com', 'rol': Roles.CLASIFICACION},
...
# Crear DiarioDigital
diario, _ = DiarioDigital.objects.get_or_create(nombre="La Voz Urbana", url_principal="https://lavozurbana.com")
...
for i in range(3):
    ...
    link.categorias.set([categorias['bandas criminales'], categorias['conflictividad barrial']])
    links.append(link)
